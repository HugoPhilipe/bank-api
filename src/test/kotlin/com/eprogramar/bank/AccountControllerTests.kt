...
class AccountControllerTests {
    ...
    @Test
    fun `test find all`(){
        accountRepository.save(Account(name = "test", document = "36950513", phone = "987654321"))
    ...
    @Test
    fun `test find by id`(){
        val account =  accountRepository.save(Account(name = "test", document = "36950513", phone = "987654321"))
    ...
    fun `test create account`(){
        val account = Account(name = "test", document = "36950513", phone = "987654321")
